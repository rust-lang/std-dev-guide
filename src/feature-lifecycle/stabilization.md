...
Check to see if a [FCP] has completed on the [tracking issue]. If not, either ping `@rust-lang/libs` or leave a comment asking about the status of the feature.
...
[tracking issue]: ./tracking-issues.md
[FCP]: ./appendix/glossary.md#fcp
